...
var HomePageTemplate = '<div class="row"><div class="col s12 center"><img style="height:96px;" src="{{ cdnLink(\'/images/logo/android-chrome-192x192.png\') }}" alt="LoLSqaure logo" /><h2 style="margin-top:1.5rem"><b>{{ babel("base.welcometololsquare") }}</b></h2></div></div><div class="row"><div class="col s12"><div id="search-your-summoner"><i class="far fa-search prefix grey-text"></i><input placeholder="{{ isUserLogged() ? babel("base.searchsummonerorteam") : babel("base.searchyoursummoner") }}" type="text"><a onclick="HomeCallLoadSummBtnClick();" class="btn-flat waves-effect"><i class="far fa-arrow-right grey-text text-darken-1"></i></a></div></div></div><div style="margin: 3rem auto;" class="divider"></div><div class="row"><div class="col s12 bindpromo" style="padding:0;"><blockquote class="special" style="margin-top: 0;">Dai un occhiata alla<a href="https://michelelucini.github.io/lolsquare/LandingPage.html" style="margin: 8px 12px" class="btn white black-text waves-effect">Landing page</a></blockquote></div></div><div style="margin: 3rem auto;" class="divider"></div><div id="rowHomeTournament" class="row nmb dnone"><div class="col s12 ttl"><h5>{{ babel("home.featuredtournamentstitle") }}</h5></div></div><div id="rowHomeNoTournament" class="row dnone"><div class="wnc"></div><div class="nocontent small"><i class="fad fa-trophy"></i><br /><span>{{ babel("home.notournaments") }}</span></div><div class="col s12 center" style="padding:0;margin-top:1rem"><a class="chip hoverable-light" style="cursor:pointer;" {{* getPageNavigations("FAQ",4) }}><i class="far fa-question-circle left"></i>{{ babel("tournament.createatorunamentpromo") }}</a></div></div><div id="user-first-steps" class="row dnone"></div>';
